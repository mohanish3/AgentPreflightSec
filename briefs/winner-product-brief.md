...
- **Vacant market wedge.** The scanner market is crowded; the remediation-first AI-patch market is not. No existing tool — not mcp-scan, not Snyk Agent Scan — delivers the complete loop: offline-first scan → Codex AI patch proposal → developer review → rescan proof. OWASP published MCP security guidance in 2025; this is the first tooling built from that taxonomy.
